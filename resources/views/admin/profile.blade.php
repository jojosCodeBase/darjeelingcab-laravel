            ...
            <div class="col-md-4 col-xl-3">
                <div class="card mb-3">
                    ...
                    <div class="card-body text-center">
                        <img src="{{ asset('assets/img/avatars/avatar-4.jpg') }}" alt="Christina Mason" class="img-fluid rounded-circle mb-2"
                ...
                <div class="card">
                    ...
                    <div class="card-body h-100">
                        ...
                        <div class="d-flex align-items-start">
                            <img src="{{ asset('assets/img/avatars/avatar-5.jpg') }}" width="36" height="36" class="rounded-circle me-2"
                                alt="Vanessa Tucker">
                        ...
                        <hr />
                        <div class="d-flex align-items-start">
                            <img src="{{ asset('assets/img/avatars/avatar.jpg') }}" width="36" height="36" class="rounded-circle me-2"
                                alt="Charles Hall">
                            <div class="flex-grow-1">
