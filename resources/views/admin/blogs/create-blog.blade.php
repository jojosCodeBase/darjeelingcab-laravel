    ...
    <main class="p-4 sm:p-6 lg:p-8">
        <div id="blogFormSection">
            <div class="mb-6">
                ...
                <h2 class="text-gray-900 text-2xl font-bold mb-1">Write New Blog Post</h2>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-1 gap-4">
                                <div>
                                    <label class="text-gray-700 text-sm mb-2 block font-semibold">Featured Thumbnail
                                        *</label>
                                    <input type="file" name="thumbnail" id="thumbnailInput" required accept="image/*"
                                    ...
                                    <img id="previewThumbnail" alt="Preview"
                                        class="mt-3 rounded-lg max-h-64 border hidden">
                                </div>
                            </div>

                            <div>
                                <label class="text-gray-700 text-sm mb-2 block"><span class="font-semibold">Excerpt*</span> <i>(Brief detail of the blog to show in card)</i></label>
                            ...
                            <div>
                                ...
                                <textarea name="content" id="content-editor" rows="12"
                                    class="w-full bg-gray-50 text-gray-900 rounded-lg px-4 py-3 outline-none border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200">{{ old('content') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="space-y-4">
                            <p class="text-xs text-amber-600 font-medium bg-amber-50 p-2 rounded border border-amber-100">
                                <i class="fas fa-info-circle mr-1"></i> Note: If Meta images are not uploaded, the main
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="file" name="og_image" id="og_image" accept="image/*"
                                        ...
                                        class="w-full bg-gray-50 text-gray-900 rounded-lg px-4 py-3 outline-none border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 file:mr-4 file:py-1 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-pink-50 file:text-pink-700 hover:file:bg-pink-100">
                                    <img id="og_image_preview" class="mt-2 rounded-md max-h-32 hidden">
                                </div>
                                <div>
                                    ...
                                    <input type="file" name="twitter_image" id="twitter_image" accept="image/*"
                                        ...
                                        class="w-full bg-gray-50 text-gray-900 rounded-lg px-4 py-3 outline-none border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 file:mr-4 file:py-1 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-pink-50 file:text-pink-700 hover:file:bg-pink-100">
                                    <img id="twitter_image_preview" class="mt-2 rounded-md max-h-32 hidden">
                                </div>
                            </div>
                        </div>
                    </div>
