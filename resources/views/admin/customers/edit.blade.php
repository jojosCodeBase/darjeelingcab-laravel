...
@section('content')
    <div class="container-fluid p-0">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title text-uppercase mb-3">Edit Customer Details</h4>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <select name="customer_type" class="form-select border-bottom" id="validationCustom01"
                                    ...
                                    <option value="Customer" @if ($customer->customer_type == 'Customer') selected @endif>Customer
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" value="{{ $customer->full_name }}" name="full_name"
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="phone_no" value="{{ $customer->phone_no }}"
                        ...
                        <div class="col-md-8">
                            <div class="form-group mb-3">
                                ...
                                <textarea id="address" cols="30" rows="5" name="address" class="form-control border-bottom" placeholder="Start typing here...." required>{{ $customer->address }}</textarea>
                            </div>
                        </div>
                    </div>
