...
<head>
    ...
    <title>500 Internal Server Error | Darjeeling Cab</title>
...
<body>
    <div class="error-page" style="background-image: url('{{ asset('assets/images/error-page-background.jpg') }}')">
        ...
        <div class="content">
            ...
            <h2 class="fw-bold">Internal Server Error</h2>
            <p>We're experiencing some technical difficulties at <strong>Darjeeling Cab</strong>. Please try again
                later.</p>
            <p>We apologize for the inconvenience and are working to resolve the issue as soon as possible.</p>
