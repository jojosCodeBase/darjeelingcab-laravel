            ...
            <div class="container">
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                    ...
                    <div class="offcanvas-header border-bottom">
                        <h2 class="offcanvas-title text-brand fw-bolder" id="offcanvasNavbarLabel">Menu</h4>
                    ...
                    <div class="offcanvas-body">
                        ...
                        <div class="d-lg-none mt-3">
                            <a href="tel:+919339342603" class="btn btn-brand w-100">Book Now</a>
                        </div>
                    </div>
                </div>

                <div class="btn btn-brand d-none d-lg-block mx-lg-5 btn-mob">
